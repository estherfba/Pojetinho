...
st.write("Olá, queridos! Você já pensou 'nossa, queria tanto ler um livro de __________' mas não sabe nem por onde começar a procurar? Isso é pra você!")

st.write("Nada mais que um projetinho de férias de verão, fruto da abstinência (voluntária, to bem) de crusader kings/the sims/netflix. Espero que seja útil a alguém - caso contrário, well you live you learn. Ainda ta na versão betinha kkkk fique a vontade para dar o seu feedback!")
